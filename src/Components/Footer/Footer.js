...
const footer = () => (
    ...
    ​           DEKORACJE ŚLUBNE WYKONUJEMY NA TERENIE {'\n'}NOWEGO Sącza, OKOLIC ORAZ CAŁEJ MAŁOPOLSKI {'\n'}
        ...
        <div className="fb-page" data-href="http://www.facebook.com/1123264691068340" data-tabs="" data-height="400" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
            <blockquote cite="http://www.facebook.com/1123264691068340" className="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/1123264691068340">Pracownia Eustoma - dekoracje i florystyka</a></blockquote></div>
        </div>
    </footer>
);
