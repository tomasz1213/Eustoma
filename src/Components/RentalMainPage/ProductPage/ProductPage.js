			...
			<div className={classes.Conteiner}>
				...
				<section className={classes.RightSide}>
					...
					>
						...
						<li>
							wypożyczalnia działa na terenie całej Polski – na Państwa życzenie
							wysyłamy asortyment w dowolne miejsce
						</li>
						<li>
							przy rezerwacji asortymentu podpisujemy umowę, która jest
							gwarancją terminu (umowę otrzymują Państwo mailem w ciągu 3 dni od
							rezerwacji)
						</li>
						<li>
							po podpisaniu umowy prosimy o wpłacenie zadatku w kwocie zgodniej
							z zapisem w umowie
						</li>
						<li>
							pozostałą należność + kaucję zwrotną wpłacają Państwo przed
							wysyłką
						</li>
						<li>kaucja zwracana jest przy zwrocie towaru</li>
						<li>
							wysyłkę otrzymują Państwo w czwartek lub piątek do godz. 12:00
							poprzedzający uroczystość
						</li>
						<li>
							zwrot asortymentu do wtorku po uroczystości, ewentualnie do środy
							po wcześniejszym uzgodnieniu
						</li>
						<li>koszty wysyłki i zwrotu leżą po stronie klienta</li>
						<li>możliwy odbiór osobisty w Nowym Sączu</li>
						<li>
							asortyment otrzymują Państwo czysty, wyprasowany – przygotowany do
							użycia
						</li>
						<li>
							zwracany towar musi być w stanie niezmienionym (czyste, wyprane,
							wyprasowane)
						</li>
						<li>ewentualne zniszczenia pokrywane są z kaucji</li>
						<li>
							istnieje możliwość zwrotu niewyczyszczonych produktów, doliczana
							jest wówczas opłata za czyszczenie/pranie: 10 zł/szt
						</li>
