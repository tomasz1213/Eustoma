...
const ImgElement = (props) => {
    ...
    return(
            <div id='SLIDER_PRODUCT' onMouseOver={()=> changeBackground(true)} onMouseOut={() => changeBackground(false)} className={props.fat ?classes.ImgElement : classes.ImgElement2} onClick={props.onClick}>
                <img className={props.fat ?classes.ImgE2 : classes.ImgE} alt={props.alt} src={imgSrc}></img>
