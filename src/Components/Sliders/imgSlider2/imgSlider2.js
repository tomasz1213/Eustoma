...
const ImgSlider2 = () => {
	...
	return (
		<div className={classes.Slider}>
			<div onClick={() => moveSlider(true)} className={classes.SliderLeft}>
				<i className="icon-left-open-big"></i>{" "}
			</div>
			<div className={classes.Foto}>{imageElements}</div>
			<div onClick={() => moveSlider(false)} className={classes.SliderRight}>
